...
if(isset($_GET['loc'])){$loc=$_GET['loc'];} else {$loc='1';}
?>
	...
	$targetpage = "LocationWiseProperty.php?"; 	
	$limit =10; 
	$result1 = DB::query("SELECT * FROM propertyList WHERE location='$loc' and pactive='1'");
	
	include 'admin/include/pagin.php';
	
	$query1 = "SELECT * FROM propertyList WHERE location='$loc' and pactive='1' ORDER BY pid desc LIMIT $pag, $limit";
	...
	$dbx=DB::count();
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="property-grids-filter">
                            <ul class="filter">
                                ...
                                <li>Properties in <?=locationName($loc)?>  (<?=$dbx?> Results)</li>
                            </ul>
                    ...
                    else {$pimage='admin/assets/uploadedPropertyPics/'.explode(",",$j['pimage_name'])[0];}
