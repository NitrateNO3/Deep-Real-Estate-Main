                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                         <form id="addProperty">
                                        <h4 class="header-title">Add Property Picture</h4>
                                       
                                                  <div class="row align-items-center"> 
                                                     
                                                     <div class="mb-3 col-12">
                                                        <label for="epimage_name" class="form-label">Property Image</label>
                                                        <input type="file" id="pimage_name" name="pimage_name" class="form-control">
                                                    </div>
...
formData.append('file[]', $('#pimage_name')[0].files[0]);
...
$.ajax({
       ...
       success: function(data){
           if(data=='Picture Added!'){ window.location.href = 'ListProperty.php';} else {
            alert(data);}
