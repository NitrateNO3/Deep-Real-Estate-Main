                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="card">
                                    <div class="card-body">
                                         <form id="addProperty">
                                        <h4 class="header-title">Add New Property</h4>
                                           ...
                                           <a href="#" style='float:right'  data-bs-toggle="modal" data-bs-target="#addLocation">Add New</a>
                                            ...
                                            <div class="row align-items-center">
                                                    <div class="mb-3  ">
                                                        ...
                                                        <input type="text" id="sublocation" class="form-control" name="sublocation">
                                                    </div>
                                            </div>
                                            <div class="row align-items-center">
                                                    <div class="mb-3 ">
                                            ...
                                            <div class="row align-items-center">
                                                    ...
                                                    <div class="mb-3 col-6 row">
                                                        ...
                                                        <div class="col-6">  
                                                        <input type="text" id="psize" class="form-control " name="psize">
                                                        </div><div class="col-6">  
...
foreach($amn as $a){
                    echo "<option value='".$a['ame_name']."'>".$a['ame_name']."</option>";
} ?>
                                                </select>
                                                </div>
                                                  ...
                                                  <div class="row align-items-center"> 
                                                    <div class="mb-3 col-auto">
                                                        ...
                                                        <input type="text" id="contact_person" value="<?=$admin['OwnerName']?>" name="contact_person" class="form-control">
                                                    </div>
                                                      <div class="mb-3 col-auto">
                                                        <label for="contact_no" class="form-label">Contact No</label>
                                                        <input type="text" id="contact_no" name="contact_no" value="<?=$admin['Mobile1']?>" class="form-control">
                                                    </div>
                                                    </div>
...
var floatRegex = /^((\d+(\.\d *)?)|((\d*\.)?\d+))$/;
             ...
             if($("#purpose").val() == ''){alert('"Property On" cannot be Empty!');} else
                ...
                $.ajax({
                    type: "POST",  
                    url: "include/function_do.php?addProperty=1", 
                ...
                data1=data.split("^");
                if(data1[1]=='Property Added!'){ window.location.href = 'AddPropertyPictures.php?pid='+data1[0];} else {
                alert(data);}
