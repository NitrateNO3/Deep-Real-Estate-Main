...
$uz=DB::query("SELECT * FROM web_owner ")[0];
$headers = "MIME-Version: 1.0" . "\r\n";
$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
$headers .= 'From: '.$uz['CompanyName'].'<'.$uz['Email1'].'>' . "\r\n";

$headersadmin = "MIME-Version: 1.0" . "\r\n";
$headersadmin .= "Content-type:text/html;charset=UTF-8" . "\r\n";
$headersadmin .= 'From: '.$uz['CompanyName'].'<'.$uz['Email1'].'>' . "\r\n";

define("HEADERS", $headers);
define("HEADERSADMIN", $headersadmin);
$admin=DB::query("SELECT * FROM web_owner")[0];
?>