/* Extracted verbatim from the reference site's terms.dc.html — its own
...
export const termsUpdated = 'Last updated: 4 July 2022';
...
export const termsSections: PolicySection[] = [
  {
    ...
    "blocks": [
      {
        "t": "p",
        "text": "Welcome to Deep Real Estate (“Company”, “we”, “our”, “us”)!"
      },
      {
        "t": "p",
        "text": "These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at www.deeprealestate.in (together or individually “Service”) operated by Deep Real Estate."
      },
      {
        "t": "p",
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "t": "p",
        "text": "You can contact our Copyright Agent via email at info@deeprealestate.in."
      }
    ]
  },
  {
