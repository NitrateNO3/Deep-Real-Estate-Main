...
?>
	...
	$limit =10; 
	$result1 = DB::query("SELECT * FROM propertyList WHERE ptype='2' and pactive='1'");
	
	include 'admin/include/pagin.php';
	
	$query1 = "SELECT * FROM propertyList WHERE ptype='2' and pactive='1' ORDER BY pid desc LIMIT $pag, $limit";
	$hj = DB::query($query1);
                    ?>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="property-grids-filter">
                            <ul class="filter">
                                ...
                                <li>Residential Properties  (<?=$total_pages?> Results)</li>
                            </ul>
